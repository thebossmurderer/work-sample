    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('productList', 'صفحه لیست محصولات'), ('productDetail', 'صفحه جزئیات محصولات'), ('aboutUs', 'صفحه درباره ما')], max_length=200, verbose_name='جایگاه نمایشی')),
            ],
            options={
